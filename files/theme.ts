...
export const DARK: ColorTokens = {
  background: P[950], foreground: P[50],
  card: P[800], cardForeground: P[50],
  popover: P[900], popoverForeground: P[50],
  primary: P[50], primaryForeground: P[950],
  muted: P[800], mutedForeground: P[400],
  accent: P[700], accentForeground: P[50],
  border: P[700], input: P[800], ring: P[500],
  sidebar: P[900],

  surface: P[900], raised: P[800], hover: P[700],
  line: P[700], lineSoft: P[800],
  ink: P[50], ink2: P[200], ink3: P[400], ink4: P[600],
  acc: P[400], accStrong: P[300], accFaint: P[800],
  keyBg: P[700], keyInk: P[50],
  badgeBg: P[700], badgeInk: P[300],
  toggleOn: P[500],
  btnPrimary: P[50], btnPrimaryInk: P[950],
  btnSoftBg: P[800], btnSoftInk: P[200],
  chartTrack: P[800],
  dataHigh: P[500], dataMid: P[400], dataLow: P[300], dataFaint: P[700],
  heatEmpty: P[800],
};
