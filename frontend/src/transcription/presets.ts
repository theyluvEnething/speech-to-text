...
export const PRESETS: Preset[] = [
  {
    ...
    instruction: [
      ...
      "Light Markdown is welcome where it genuinely aids clarity — the occasional",
      "heading or a few bullet points for distinct items — but keep formatting",
      "restrained: no heavy or nested formatting, no bold on everything, no walls",
      'of bullets. Do not add a "Prompt:" label or wrap the output in quotes.',
